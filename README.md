...
* 搬运[原教程](https://blog.432100.xyz/index.php/archives/50/)说法：**不保证一定能续期！不保证一定能续期！不保证一定能续期！**，或者说，**只是增大续订可能性**。(E5续订一般在最后20天左右发通知)
* 若理解并接受上述说明，请接着操作；**若否，请点击浏览器右上角 X 。**
> 旧版（AutoApi-test这个项目名字的）必须更新，至于我其他的更新就不用管了，都是可有可无的更新。
